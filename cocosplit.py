#python D:\temp_save\sahi\without_negative_frame\training\cocosplit.py --having-annotations --multi-class -s 0.8 D:\temp_save\sahi\without_negative_frame\annot\sliced_coco_modify.json D:\temp_save\sahi\without_negative_frame\training\train.json D:\temp_save\sahi\without_negative_frame\training\test.json
#python <path_to>cocosplit.py --having-annotations --multi-class -s 0.8 <path_to>coco.json <path_to_save>train.json <path_to_save>test.json
